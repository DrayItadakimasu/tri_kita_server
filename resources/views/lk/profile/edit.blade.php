...
@section('content')
    <div class="col middle-block">
        ...
        <div class="row">
            <div class="col-xl-7">
                <form action="{{ $action }}" method="{{ $method }}" id="edit_profile_form" class="row" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="col-xl-5">
                ...
                <div class="row justify-content-end p-0">
                    <button onclick="document.querySelector('#edit_profile_form').submit();" class="edit-submit text-center text-white mr-3">
                        Сохранить все
                    </button>
                </div>
            </div>
